...
class Input extends Component {
  ...
  render() {
    ...
    const inputProps = Object.assign(this.props.props, { value: this.props.props.value
    ...
    return React.createElement('div', divProps, React.createElement('label', labelProps, this.props.label.text), 
    React.createElement('input', inputProps, null), 
    this.props.help?React.createElement('span', helpProps, helpTxt):null, 
    !this.state.isValid ? React.createElement('span', errorProps, errTxt) : null);
  }
}
